      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            {/* Social Media */}
            <div className="mb-5">
              <h4 className="mb-3 text-xs font-medium uppercase tracking-wider text-carreta-eggshell/50">
                {t("footer.followUs")}
              </h4>
              <div className="flex gap-3">
                <a
                  href="https://www.facebook.com/profile.php?id=61579056277305"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-carreta-eggshell/70 transition-all hover:bg-[#1877F2] hover:text-white hover:shadow-lg"
                ...
                <a
                  href="https://instagram.com/puravidaminds"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-carreta-eggshell/70 transition-all hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#FCAF45] hover:text-white hover:shadow-lg"
